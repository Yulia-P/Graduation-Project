...
export const UpdateArticlesPage = () => {
    ...
    const submitHandler = () => {
        try {
            const updatedArticles = {'title':title, 'text':text, 'id':params.id, 'image':newImage}
            //     new FormData()
            // updatedArticles.append('title', title)
            // updatedArticles.append('text', text)
            // updatedArticles.append('id', params.id)
            // updatedArticles.append('image', newImage)
